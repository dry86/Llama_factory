...
def main():
    ...
    parser.add_argument("--model", type=str, default="/newdisk/public/wws/01-AIGC-GPRO/LLaMA-Factory/output/Qwen2-VL-qwen2vl_lora_sft_3e", help="HF hub id or local dir")
