...
def main():
    ...
    parser.add_argument("--model", type=str, default="/newdisk/public/wws/01-AIGC-GPRO/LLaMA-Factory/output/qwen2vl_7b/lora_450v3_sft_4e_lr1e-4", help="HF hub id or local dir")
